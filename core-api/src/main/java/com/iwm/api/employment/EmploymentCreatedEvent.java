 ...
 */
public class EmploymentCreatedEvent {
    ...
    public EmploymentCreatedEvent(EmploymentId employmentId, EmployeeId employeeId, Date createdDate, Date startDate, Date endDate) {
